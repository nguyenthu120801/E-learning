...
public class RemovePayMent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Vector<Courses> vector = daoCourse.getAllCourses();
            ...
            if (service.equals("Remove")) {
                ...
                if (course == null) {
                    daoCourse.deleteCourse(id);
                    request.setAttribute("displayCourses", vector);
                    //Dispatcher.dispatch(request, response, "pay.jsp");
