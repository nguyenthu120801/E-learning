...
public class StartQuiz extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Quiz> list_quiz = new QuizDAO().getAllQuizzes(lesson_id);
        HttpSession session = request.getSession();
        session.setAttribute("list_quiz", list_quiz);
        session.setAttribute("lesson_id", lesson_id);
        ...
        request.setAttribute("quiz", list_quiz.get(0));
        if (list_quiz.size() == 1) {
